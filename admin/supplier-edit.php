...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
			$statement = $pdo->prepare("UPDATE supplier SET supplier_name=?, supplier_address=? , supplier_contact=? ,NIC=? WHERE supplier_id=?");
    		$statement->execute(array($_POST['supplier_name'],$_POST['supplier_address'],$_POST['supplier_contact'],$_POST['nic'],$_REQUEST['id']));
...
if(!isset($_REQUEST['id'])) {
	...
	$statement = $pdo->prepare("SELECT * FROM supplier WHERE supplier_id=?");
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" autocomplete="off" class="form-control" name="supplier_contact" value="<?php echo $supplier_contact; ?>">
                            </div>
						</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" autocomplete="off" class="form-control" name="nic" value="<?php echo $nic; ?>">
                            </div>
                        </div>
