                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="../assets/uploads/<?php echo $_SESSION['user']['photo']; ?>" class="user-image"
                                 alt="User Image">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview <?php if (($cur_page == 'weight.php') || ($cur_page == 'weight-add.php') || ($cur_page == 'weight-edit.php') || ($cur_page == 'brand.php') || ($cur_page == 'brand-add.php') || ($cur_page == 'brand-edit.php') || ($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php')) {
                    ...
                    <ul class="treeview-menu">
                        <li><a href="weight.php"><i class="fa fa-circle-o"></i> Weight Types</a></li>
                ...
                <li class="treeview <?php if (($cur_page == 'suppliers.php')) {
                    echo 'active';
                } ?>">
                    <a href="suppliers.php">
                        <i class="fa fa-hand-o-right"></i> <span>Supplier</span>
                    </a>
                </li>

                <li class="treeview <?php if (($cur_page == 'supplier-order.php')) {
                    echo 'active';
                } ?>">
                    <a href="supplier-order.php">
                        <i class="fa fa-hand-o-right"></i> <span>Purchase Order</span>
                    </a>
                </li>

                <li class="treeview <?php if (($cur_page == 'report.php')) {
                    echo 'active';
                } ?>">
                    <a href="report.php">
                        <i class="fa fa-hand-o-right"></i> <span>Report</span>
                    </a>
                </li>
