...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['size_name'])) {
        $valid = 0;
        $error_message .= "Weight Name can not be empty<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Weight Name already exists<br>";
    	}
    }
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Weight Name <span>*</span></label>
							<div class="col-sm-4">
